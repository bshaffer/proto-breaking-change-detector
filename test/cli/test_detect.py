...
class CliDetectTest(unittest.TestCase):
    ...
    # conduct the same tests, but using suggested commit messages instead of findings
    def test_suggested_commit_with_descriptor_set_enum(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            ...
            self.assertEqual(
                result.output,
                "enum_v1.proto: remove enum `BookType`.\n",
            )

    def test_suggested_commit_with_single_directory_enum(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
    ...
    def test_suggested_commit_with_single_directory_enum_completely_removed(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
    ...
    def test_suggested_commit_with_single_directory_enum_without_updated_protos(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
    ...
    def test_suggested_commit_with_single_directory_service_empty(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            ...
            self.assertEqual(
                result.output,
                "service_v1.proto: remove service `Example`.\n"
                + "service_v1.proto: remove message `FooRequest`.\n"
                + "service_v1.proto: remove message `FooResponse`.\n"
                + "service_v1.proto: remove message `BarRequest`.\n"
                + "service_v1.proto: remove message `BarResponse`.\n",
            )

    def test_suggested_commit_with_single_directory_change_to_optional(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            ...
            self.assertEqual(
                result.output,
                "optional.proto: change proto3 optional flag of field `.example.v1.Test.enabled`.\n",
            )

    def test_suggested_commit_with_single_directory_enum_alias(self):
        # Mock the stdout so that the unit test does not
        # print anything to the console.
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
    ...
    def test_suggested_commit_with_single_directory_message(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "message_v1.proto: move message `Person` from `message_v1.proto` to `message_v1beta1.proto`.\n"
                + "message_v1.proto: move message `PhoneNumber` from `message_v1.proto` to `message_v1beta1.proto`.\n"
                + "message_v1.proto: remove field `.tutorial.v1.Person.type`.\n"
                + "message_v1.proto: move message `AddressBook` from `message_v1.proto` to `message_v1beta1.proto`.\n"
                + "message_v1beta1.proto: change type of field `.tutorial.v1.Person.id` from `int32` to `string`.\n"
                + "message_v1beta1.proto: rename field `.tutorial.v1.Person.email` to `.tutorial.v1.Person.email_address`.\n"
                + "message_v1beta1.proto: change repeated flag of field `.tutorial.v1.Person.phones`.\n"
                + "message_v1beta1.proto: move field `.tutorial.v1.Person.single` out of oneof.\n",
            )

    def test_suggested_commit_with_single_directory_message_all_changes(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                ...
                + "message_v1.proto: remove field `.tutorial.v1.Person.type`.\n"
                + "message_v1.proto: move message `AddressBook` from `message_v1.proto` to `message_v1beta1.proto`.\n"
                + "message_v1beta1.proto: change comment of message `Person`.\n"
                + "message_v1beta1.proto: change comment of field `.tutorial.v1.Person.name`.\n"
                + "message_v1beta1.proto: change comment of field `.tutorial.v1.Person.id`.\n"
                + "message_v1beta1.proto: change type of field `.tutorial.v1.Person.id` from `int32` to `string`.\n"
                + "message_v1beta1.proto: rename field `.tutorial.v1.Person.email` to `.tutorial.v1.Person.email_address`.\n"
                + "message_v1beta1.proto: change comment of enum `PhoneType`.\n"
                + "message_v1beta1.proto: change comment of enum value `PhoneType.MOBILE`.\n"
                + "message_v1beta1.proto: add enum value `PhoneType.SCHOOL`.\n"
                + "message_v1beta1.proto: change repeated flag of field `.tutorial.v1.Person.phones`.\n"
                + "message_v1beta1.proto: move field `.tutorial.v1.Person.single` out of oneof.\n",
            )

    def test_suggested_commit_with_single_directory_service(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "service_v1.proto: remove rpc method `Example.ShouldRemove`.\n"
                + "service_v1.proto: move message `FooRequest` from `service_v1.proto` to `service_v1beta1.proto`.\n"
                + "service_v1.proto: move message `FooResponse` from `service_v1.proto` to `service_v1beta1.proto`.\n"
                + "service_v1.proto: move message `BarRequest` from `service_v1.proto` to `service_v1beta1.proto`.\n"
                + "service_v1.proto: remove field `.example.v1.BarRequest.page_size`.\n"
                + "service_v1.proto: remove field `.example.v1.BarRequest.page_token`.\n"
                + "service_v1.proto: move message `BarResponse` from `service_v1.proto` to `service_v1beta1.proto`.\n"
                + "service_v1.proto: remove field `.example.v1.BarResponse.content`.\n"
                + "service_v1.proto: remove field `.example.v1.BarResponse.next_page_token`.\n"
                + "service_v1beta1.proto: change input type of rpc method `Example.Foo` from `.example.v1.FooRequest` to `.example.v1beta1.FooRequestUpdate`.\n"
                + "service_v1beta1.proto: change response type of rpc method `Example.Foo` from `.example.v1.FooResponse` to `.example.v1beta1.FooResponseUpdate`.\n"
                + "service_v1beta1.proto: change client streaming flag of rpc method `Example.Bar`.\n"
                + "service_v1beta1.proto: change server streaming flag of rpc method `Example.Bar`.\n"
                + "service_v1beta1.proto: change pagination feature of rpc method `Example.PaginatedMethod`.\n",
            )

    def test_suggested_commit_with_single_directory_service_all_changes(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                ...
                + "service_v1.proto: remove field `.example.v1.BarResponse.content`.\n"
                + "service_v1.proto: remove field `.example.v1.BarResponse.next_page_token`.\n"
                + "service_v1beta1.proto: change comment of service `Example`.\n"
                + "service_v1beta1.proto: change comment of rpc method `Example.Foo`.\n"
                + "service_v1beta1.proto: change input type of rpc method `Example.Foo` from `.example.v1.FooRequest` to `.example.v1beta1.FooRequestUpdate`.\n"
                + "service_v1beta1.proto: change response type of rpc method `Example.Foo` from `.example.v1.FooResponse` to `.example.v1beta1.FooResponseUpdate`.\n"
                + "service_v1beta1.proto: change client streaming flag of rpc method `Example.Bar`.\n"
                + "service_v1beta1.proto: change server streaming flag of rpc method `Example.Bar`.\n"
                + "service_v1beta1.proto: change pagination feature of rpc method `Example.PaginatedMethod`.\n"
                + "service_v1beta1.proto: add message `FooRequestUpdate`.\n"
                + "service_v1beta1.proto: add message `FooResponseUpdate`.\n",
            )

    def test_suggested_commit_with_single_directory_service_annotation(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "service_annotation_v1.proto: remove method_signature `content,error` from rpc method `Example.Foo`.\n"
                + "service_annotation_v1.proto: move message `FooRequest` from `service_annotation_v1.proto` to `service_annotation_v1beta1.proto`.\n"
                + "service_annotation_v1.proto: move message `FooResponse` from `service_annotation_v1.proto` to `service_annotation_v1beta1.proto`.\n"
                + "service_annotation_v1.proto: remove message `FooMetadata`.\n"
                + "service_annotation_v1beta1.proto: change google.api.http annotation `http_method` of rpc method `Example.Foo`.\n"
                + "service_annotation_v1beta1.proto: change google.api.http annotation `http_body` of rpc method `Example.Bar`.\n"
                + "service_annotation_v1beta1.proto: change long running operation metadata type of rpc method `Example.Bar` from `FooMetadata` to `FooMetadataUpdate`.\n",
            )

    def test_suggested_commit_with_single_directory_method_signature_order(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "signature_order_v1.proto: change position of method_signature `id,content` of rpc method `Example.Foo`.\n"
                + "signature_order_v1.proto: change position of method_signature `id,uri` of rpc method `Example.Foo`.\n"
                + "signature_order_v1.proto: move message `FooRequest` from `signature_order_v1.proto` to `signature_order_v1beta1.proto`.\n"
                + "signature_order_v1.proto: move message `FooResponse` from `signature_order_v1.proto` to `signature_order_v1beta1.proto`.\n",
            )

    def test_suggested_commit_with_oslogin_proto_alpha(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "google/cloud/oslogin/v1/oslogin.proto: remove packaging option `Google::Cloud::OsLogin::V1` from `ruby_package`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove default host `oslogin.googleapis.com` from service `OsLoginService`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove oauth_scope `https://www.googleapis.com/auth/cloud-platform` from service `OsLoginService`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove oauth_scope `https://www.googleapis.com/auth/compute` from service `OsLoginService`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name` from rpc method `OsLoginService.DeletePosixAccount`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name` from rpc method `OsLoginService.DeleteSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name` from rpc method `OsLoginService.GetLoginProfile`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name` from rpc method `OsLoginService.GetSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `parent,ssh_public_key` from rpc method `OsLoginService.ImportSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `parent,ssh_public_key,project_id` from rpc method `OsLoginService.ImportSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name,ssh_public_key` from rpc method `OsLoginService.UpdateSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove method_signature `name,ssh_public_key,update_mask` from rpc method `OsLoginService.UpdateSshPublicKey`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.DeletePosixAccountRequest.name`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.DeleteSshPublicKeyRequest.name`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.GetLoginProfileRequest.name`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove field `.google.cloud.oslogin.v1.GetLoginProfileRequest.project_id`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove field `.google.cloud.oslogin.v1.GetLoginProfileRequest.system_id`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.GetSshPublicKeyRequest.name`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.ImportSshPublicKeyRequest.parent`.\n"
                + "google/cloud/oslogin/v1/oslogin.proto: remove resource_reference option from field `.google.cloud.oslogin.v1.UpdateSshPublicKeyRequest.name`.\n",
            )

    def test_suggested_commit_with_oslogin_proto_beta(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "google/cloud/oslogin/v1beta/oslogin.proto: change field behavior of field `.google.cloud.oslogin.v1.ImportSshPublicKeyRequest.ssh_public_key`.\n",
            )

    def test_suggested_commit_with_pubsub_proto(self):
        pubsub_v1beta2 = os.path.join(
            self.GOOGLEAPI_DIR, "google/pubsub/v1beta2/pubsub.proto"
        )
        pubsub_v1 = os.path.join(self.GOOGLEAPI_DIR, "google/pubsub/v1/pubsub.proto")
        with patch("sys.stdout", new=StringIO()):
            ...
            self.assertEqual(
                result.output,
                "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.Topic.name`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.GetTopicRequest.topic`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.PublishRequest.topic`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.PublishRequest.messages`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ListTopicsRequest.project`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ListTopicSubscriptionsRequest.topic`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.DeleteTopicRequest.topic`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.Subscription.name`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.Subscription.topic`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.GetSubscriptionRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ListSubscriptionsRequest.project`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.DeleteSubscriptionRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ModifyPushConfigRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ModifyPushConfigRequest.push_config`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.PullRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.PullRequest.max_messages`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ModifyAckDeadlineRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: add REQUIRED field `.google.pubsub.v1beta2.ModifyAckDeadlineRequest.ack_ids`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.ModifyAckDeadlineRequest.ack_deadline_seconds`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.AcknowledgeRequest.subscription`.\n"
                + "google/pubsub/v1/pubsub.proto: change field behavior of field `.google.pubsub.v1beta2.AcknowledgeRequest.ack_ids`.\n"
                + "google/pubsub/v1beta2/pubsub.proto: remove field `.google.pubsub.v1beta2.ModifyAckDeadlineRequest.ack_id`.\n",
            )

    def test_suggested_commit_with_tts_proto(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
    ...
    def test_suggested_commit_with_nonbreaking_changes_not_reported(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
    ...
    def test_suggested_commit_with_nonbreaking_changes_reported_if_requested(self):
        with patch("sys.stdout", new=StringIO()):
            runner = CliRunner()
            result = runner.invoke(
                detect,
            ...
            self.assertEqual(
                result.output,
                "file.proto: add field `.test_non_breaking.Message.added`.\n",
            )
